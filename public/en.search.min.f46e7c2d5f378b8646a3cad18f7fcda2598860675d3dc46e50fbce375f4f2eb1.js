...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.1af375305a5b8ed6f81f41dff82f4dff25f286c803e64dd100ed77caec73a44a.js',function(){input.required=false;search();});}
