...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.cd451d9d497927653db520052a6f296c195137142c126f673e620824bca1cc23.js',function(){input.required=false;search();});}
