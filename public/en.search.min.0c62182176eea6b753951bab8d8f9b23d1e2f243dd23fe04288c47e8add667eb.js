...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.ccee18ba0a9659a0051a48d65666bdae4a16da530d23282e19e8eb2ae447806e.js',function(){input.required=false;search();});}
