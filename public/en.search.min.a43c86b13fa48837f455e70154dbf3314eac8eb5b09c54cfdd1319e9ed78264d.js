...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.4183a067dfebfd18029022ea9fc2341a32a034e145ec8f155bf88cbe1ac4d51d.js',function(){input.required=false;search();});}
