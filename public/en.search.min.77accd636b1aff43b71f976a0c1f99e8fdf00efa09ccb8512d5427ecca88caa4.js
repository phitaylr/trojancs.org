...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.cf349fd6740a26b776594cc272edc09f77c76a5796c245fbb6ec133a9dfea761.js',function(){input.required=false;search();});}
