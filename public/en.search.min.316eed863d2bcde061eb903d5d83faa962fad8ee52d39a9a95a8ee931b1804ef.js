...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.d685ea0cd59e242dabea0e58a0dc01e6ab3a3d6a7808b857c4783fc4f78f47a1.js',function(){input.required=false;search();});}
